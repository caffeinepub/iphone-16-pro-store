...
export class Backend implements backendInterface {
    ...
    async getAggregateRating(): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getAggregateRating();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async submitOffer(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
